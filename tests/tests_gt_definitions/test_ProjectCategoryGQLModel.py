...
test_reference_projectcategories = create_resolve_reference_test(table_name='projectcategories', gqltype='ProjectCategoryGQLModel', attribute_names=["id", "name", "name_en", "lastchange"])
