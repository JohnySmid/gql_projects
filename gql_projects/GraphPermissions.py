...
from gql_projects.utils.Dataloaders import getUgConnection, getLoadersFromInfo
...
def RoleBasedPermission(roles: str = "", whatreturn=[]):
    ...
    from gql_projects.GraphTypeDefinitions.externals import RBACObjectGQLModel
